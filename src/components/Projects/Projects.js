        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="EDA project which orchestrates a holistic comparison and assessment of the reliability and performance attributes intrinsic to Wi-Fi, Ethernet, and Starlink networks within the domain of computer networks."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Big Data project used to view quantifiable & statistical COVID-19 data from the World Health Organization and Global Data Change Lab using Apache Spark"
